...
上面我已经介绍过了判别模块的损失函数，损失函数的公式如下：
 [![railroad]({{ site.images | relative_url }}/gs1.png){:width="91px"}]({{ site.images | relative_url }}/gs1.png)
 
同时生成器的损失函数为：
 [![railroad]({{ site.images | relative_url }}/gs2.png){:width="91px"}]({{ site.images | relative_url }}/gs2.png)

当生成器固定的时候，可以求导得到最优的判别模块：
 [![railroad]({{ site.images | relative_url }}/gs3.png){:width="91px"}]({{ site.images | relative_url }}/gs3.png)
